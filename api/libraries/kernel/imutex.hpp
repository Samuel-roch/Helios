...
public:
     ...
     * @return @ref ReturnCode::ErrorTimeout if @p timeout_ticks elapsed before acquisition.
     * @return @ref ReturnCode::ErrorMutexLockFailed on any other failure (e.g. deadlock detection).
     */
    [[nodiscard]]
    virtual ReturnCode lock(TickType timeout_ticks) noexcept = 0;
     ...
     * @return @ref ReturnCode::ErrorMutexLockFailed on any other failure.
     */
    [[nodiscard]]
     ...
     * @return @ref ReturnCode::ErrorMutexUnlockFailed if the mutex is not owned by the caller,
